export const FAILED_DATA_FETCHING = '정보를 가져오는데 실패했습니다.';
export const ERROR_LOG = '에러가 발생했습니다. 잠시 후 다시 시도해주세요.';
export const WRONG_LOGIN_ACCESS = '로그인이 돼있지 않아 로그인 페이지로 이동합니다.';
export const ALREADY_LOGINED = '이미 로그인이 돼있습니다. 메인 페이지로 이동합니다.';
export const SIGNUP_SUCCESS = '회원가입이 완료됐습니다. 메인 페이지로 이동합니다.';
