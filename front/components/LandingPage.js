  ...
  return (
      <>
        ...
        <div style={style}>
          <h2>시작 페이지</h2>
          {me?
          <Button onClick={onLogOut} loading={logOutLoading} style={ButtonStyle} type="primary">로그아웃하기</Button>
          :
          <Button onClick={moveLogin} style={ButtonStyle} type="primary">로그인하러 가기!</Button>}
        </div>
      </>
  );
}
